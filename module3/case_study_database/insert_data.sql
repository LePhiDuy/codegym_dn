...
/*
1.	Thêm mới thông tin cho tất cả các bảng có trong CSDL để có thể thoả mãn các yêu cầu bên dưới.Vị trí sẽ lưu trữ các thông tin: Lễ tân, phục vụ, chuyên viên, giám sát, quản lý, giá đốc.
*/

-- vi_tri: Vị trí sẽ lưu trữ các thông tin: Lễ tân, phục vụ, chuyên viên, giám sát, quản lý, giám đốc.

INSERT INTO vi_tri(ten_vi_tri) 
values ("Lễ tân"), ("Phục vụ"), ("Chuyên viên"), ("Giám sát"), ("Quản lý"), ("Giám đốc");

-- table trinh_do: Trình độ sẽ lưu trữ các thông tin: Trung cấp, Cao đẳng, Đại học và sau đại học
INSERT INTO trinh_do(ten_trinh_do)
values ("Trung cấp"), ("Cao đẳng"), ("Đại học"), ("Sau đại học");

-- table bo_phan: Sale – Marketing, Hành Chính, Phục vụ, Quản lý.
INSERT INTO bo_phan(ten_bo_phan)
values ("Sale - Marketing"), ("Hành chính"), ("Phục vụ"), ("Quản lý");

-- table loai_khach: (Diamond, Platinium, Gold, Silver, Member).
INSERT INTO loai_khach(ten_loai_khach)
values ("Diamond"), ("Plantinium"), ("Gold"), ("Silver"), ("Member"); 
SELECT * FROM loai_khach;

-- table kieu_thue: ("Năm", "Tháng", "Ngày", "Giờ")
INSERT INTO kieu_thue(ten_kieu_thue)
values ("Năm"), ("Tháng"), ("Ngày"), ("Giờ"); 

-- table loai_dich_vu: ("Villa", "House", "Room");
